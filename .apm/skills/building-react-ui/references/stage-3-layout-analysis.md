...
```bash
cd scripts
py components_search.py ../component-mapping.json
```
...
```bash
cd <your-project-root>\<skills-dir>\building-react-ui\scripts
py components_search.py <your-project-root>\component-mapping.json
```
...
```bash
cd d:\my-project\.codestudio\skills\building-react-ui\scripts
py components_search.py d:\my-project\component-mapping.json
```

**Real example (with hidden config directory like .agents):**
```bash
cd d:\my-project\.agents\skills\building-react-ui\scripts
py components_search.py d:\my-project\component-mapping.json
```

**Real example (with visible skills directory):**
```bash
cd d:\my-project\skills\building-react-ui\scripts
py components_search.py d:\my-project\component-mapping.json
```
...
- **Data sources**: 
  ...
  - `scripts/components_search.py` (BM25 mappers)
